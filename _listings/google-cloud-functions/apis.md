...
created: "2018-02-26"
modified: "2018-02-26"
url: https://raw.githubusercontent.com/streamdata-gallery/serverless/master/_listings/google-cloud-functions/apis.yaml
...
- name: Google Cloud Functions API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/serverless/master/_listings/google-cloud-functions/v1-name-get.md
x-common:
- type: x-change-log
...
- type: x-how-to-guides
  url: https://cloud.google.com/functions/docs/how-to
- type: x-monitoring
  url: https://cloud.google.com/functions/docs/monitoring/
- type: x-pricing
